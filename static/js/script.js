...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("time").innerHTML = "Thanks for attending our wedding and share this special moment with us!";
    }
}, 1000);
...
console.log('\n\n%c SAVE THE DATE: August 26th, 2022!', styles);

console.log('%cYour presence is requested!%c\n\nRegards: Jason Liu', styles1, styles2);
